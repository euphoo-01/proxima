...
- Iteration 30 adds custom Proxima chart foundation (cartesian/donut/candlestick with shared theme/axis/tooltip formatter), but current custom chart backend does not yet support candlestick zoom/pan/reset interactions from hardening spec 18.
